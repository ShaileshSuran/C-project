/*We have added actual Questions instead of dummy Questions*/
#include<iostream>
#include<string>
using namespace std;
...
q2.question_storage("7x9=?","63","72","81","83",1,10);
q3.question_storage("9-3=?","1","2","6","4",3,10);
q4.question_storage("5/1=?","1","2","3","5",4,10);
q5.question_storage("7x5=?","1","2","35","4",3,10);
q6.question_storage("2x1=?","1","2","3","4",2,10);
q7.question_storage("6x4=?","1","24","3","4",2,10);
q8.question_storage("7x3=?","1","2","21","4",3,10);
q9.question_storage("6/3=?","1","2","3","4",2,10);
q10.question_storage("2+1=?","1","3","2","4",2,10);
q11.question_storage("2+7=?","1","9","3","4",2,10);
q12.question_storage("20/4=?","1","2","5","4",3,10);
q1.ask();
q2.ask();
q3.ask();
q4.ask();
